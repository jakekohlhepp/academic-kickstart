...
slug: attanasio-levell-low-sanchez-marcos-2015-aggregating-elasticities
...
shelf: recent
deck: A direct treatment of how individual female labor-supply elasticities aggregate across intensive and extensive margins.
---
## Why it matters

The paper is exactly about one of the recurring wiki problems: individual elasticities are heterogeneous and margin-specific, so aggregation is not just averaging.

## How to use it in this wiki

- Use it after Heckman (1993) for a more modern aggregation application.
- Keep it close to female labor-supply and extensive-margin discussions.
